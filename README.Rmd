...
The package also contains a lot of undocumented functions, which can be ignored for now.
...
The function `sdsm_diagnostic` checks the performance of several link function.
